...
def get_accuracy(y_pred, y_dev, e):
...
if __name__ == '__main__':
    ...
    X_train, y_train, emojis = load_file('emoji_file_train.txt')
    X_dev, y_dev, _ = load_file('emoji_file_train.txt')
    ...
    for text in texts:
      ...
      most_prob = np.argmax(probs)
      gen_emojis.append(clf.classes_[most_prob])
